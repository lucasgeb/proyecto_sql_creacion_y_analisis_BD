...
/*PARA NO ROMPER LA INTEGRIDAD DE LAS TABLAS, LOS EJEMPLOS DE ELIMINACION DEBAJO DE ESTE COMENTARIO NO DEBEN EJECUTARSE EN ESTE SCRIPT.
FUERON PROBADO EN UNA CONSULTA APARTE CON UNA BASE DE DATOS DE PRUEBA
...
DELETE FROM Empleados WHERE SucursalID = 3;*/
...
SELECT COUNT(OrdenID) AS TotalDeRegistros
FROM Ordenes;
...
-- 5 ¿Cuáles son las sucursales con un promedio de ventas por orden superior a un valor específico, ordenadas por el promedio de kilómetros recorridos para las entregas de mayor a menor? --

SELECT SucursalID,
		CAST(AVG(TotalCompra) AS DECIMAL(10,2)) AS [Promedio Venta Por Orden],
